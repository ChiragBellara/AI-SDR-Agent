                ...
                <div className="grid gap-4">
                        ...
                        <Section title="Target Markets">
                            {persona.target_markets.industries?.length > 0 && (
                                <div className="mb-3 flex flex-wrap gap-1.5">
                                    {persona.target_markets.industries.map(
                                        (ind, i) => (
                                            <Tag key={i} text={ind} />
                                        ),
                                    )}
                    ...
                    {persona.sales_intelligence && (
                        <Section title="Sales Intelligence">
                            {persona.sales_intelligence.green_flags?.length >
                                0 && (
                                <div className="mb-3">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {persona.sales_intelligence.green_flags.map(
                                            (f, i) => (
                                                <span
                                                    key={i}
                            ...
                            {persona.sales_intelligence.red_flags?.length >
                                0 && (
                                <div className="mb-3">
                                    <div className="text-xs font-medium text-slate-500 mb-1.5">
                                        Red Flags
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {persona.sales_intelligence.red_flags.map(
                                            (f, i) => (
                                                <span
                                                    key={i}
                                                    className="inline-block rounded-full bg-red-50 px-2.5 py-0.5 text-xs text-red-700"
                                                >
                                                    {f}
                                                </span>
                                            ),
                            ...
                            {persona.sales_intelligence.compliance_standards
                                ?.length > 0 && (
                                <div>
                                    <div className="text-xs font-medium text-slate-500 mb-1.5">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {persona.sales_intelligence.compliance_standards.map(
                                            (s, i) => (
                                                <Tag key={i} text={s} />
                                            ),
                                        )}
