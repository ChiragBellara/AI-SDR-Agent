...
from .src.schema.state import InputState
from .src.nodes.grounding import GroundingNode
from .src.nodes.collector import CollectorNode
from .src.nodes.research_nodes.customers import CustomersResearcher
from .src.nodes.research_nodes.triggers import TriggersResearcher
from .src.nodes.research_nodes.news import NewsResearcher
from .src.nodes.research_nodes.offerings import OfferingsResearcher
from .src.nodes.research_nodes.readiness import ReadinessResearcher
from .src.nodes.persona import PersonaNode

logger = setup_logger(__name__)


class Graph:
    def __init__(self, company="", url="", hq_location="", industry="", job_id="") -> None:
    ...
    def _build_workflow(self):
        ...
        self.workflow.add_node("triggers_researcher",
                               self.triggers_researcher.run)
        self.workflow.add_node("offering_researcher",
                               self.offering_researcher.run)
        self.workflow.add_node("readiness_researcher",
                               self.readiness_researcher.run)
        self.workflow.add_node("customer_researcher",
                               self.customer_researcher.run)
